...
local config = require('scene.game-config').noDisplay.enemies.gunDrone
...
function M.new( instance )
  ...
  local function assignHeroProximityScores(directionScores)
    ...
    if heroDistance < config.targetHeroDist then
  ...
  local function assignParticleProximityScores(directionScores)
    ...
    directionScores.N  = directionScores.N - (directionScores.E + directionScores.W)/2
    directionScores.W  = directionScores.W - (directionScores.N + directionScores.S)/2
    directionScores.E  = directionScores.E - (directionScores.N + directionScores.S)/2
    directionScores.S  = directionScores.S - (directionScores.E + directionScores.W)/2

    directionScores.NW = directionScores.NW - (directionScores.NE + directionScores.SE)/2
    directionScores.NE = directionScores.NE - (directionScores.NW + directionScores.SE)/2
    directionScores.SW = directionScores.SW - (directionScores.NW + directionScores.SE)/2
    directionScores.SE = directionScores.SE - (directionScores.NE + directionScores.SE)/2
  ...
  -- Return instance
  instance.name = "gunDrone"
  instance.type = "gunDrone"
  return instance
end
