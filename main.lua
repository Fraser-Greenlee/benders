...
if isMobile or isSimulator then
	...
	-- stick.x, stick.y = 128, display.contentHeight + 400
	-- local button = vjoy.newButton()
	-- button.x, button.y = display.contentWidth - 128, display.contentHeight + 400
end
...
composer.gotoScene( "scene.game", { params={ map="scene/game/map/level enemy debug raycast.json" } } )
